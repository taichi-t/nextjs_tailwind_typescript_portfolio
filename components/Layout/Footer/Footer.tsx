  ...
  return (
    <footer className="mt-20">
      <div className="inner-wrap">
        ...
        <a
          className="text-2xl leading-tight inline-block bg-yellow text-primaryText"
